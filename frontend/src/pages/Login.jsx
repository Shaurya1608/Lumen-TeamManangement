...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-dark-900">
      <div 
        className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] rounded-full blur-[100px] opacity-20 bg-brand-blue/40 pointer-events-none"
      ...
      >
        <div className="text-center mb-10">
          <motion.div 
            ...
            className="w-20 h-20 bg-gradient-to-br from-brand-blue to-brand-purple rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-[0_0_40px_rgba(59,130,246,0.4)] p-[2px]"
          >
        ...
        <form onSubmit={handleLogin} className="space-y-6">
           ...
           <motion.button 
             ...
             type="submit" 
             disabled={loading} 
             className="w-full mt-4 flex items-center justify-center gap-2 bg-white text-dark-900 hover:bg-slate-200 font-bold py-4 rounded-2xl transition-all shadow-[0_0_20px_rgba(255,255,255,0.2)] disabled:opacity-50 text-base"
           >
        ...
        <p className="mt-8 text-center text-sm font-medium text-slate-400">
          New to Lumen? <Link to="/signup" className="text-white hover:text-brand-blue transition-colors relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-px after:bg-brand-blue after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:origin-left">Create an account</Link>
        </p>
      </motion.div>
    </div>
  );
